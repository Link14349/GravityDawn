...
- Start: a large 「引力破晓」 title with a minimal planet / orbit / dawn logo, transfer diagram, enlarged play / mission buttons and mission overview. The previous headline, supporting slogan and three-column principles section are removed. The two main buttons use 16–21px labels and 64–84px height, with a 54px minimum in short landscape windows.
