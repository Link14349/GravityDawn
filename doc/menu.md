...
| **[campaign.md](campaign.md)** | 引力战役 — 24 关编排、移动天体、地表稳定性、参考解与满推力反例验证 |
...
| **[design-usage.md](design-usage.md)** | 关卡设计器使用指南 — 界面布局、工具说明、操作方式、属性编辑、导出导入 |
| **[design-framework.md](design-framework.md)** | 关卡设计器技术架构 — DesignerData 数据模型、EditModeUI 渲染与交互、测试模式 |
...
| 角色 | 推荐文档 |
|------|---------|
| 关卡设计师 | design-usage.md → level.md |
| 前端开发者 | framework.md → level.md → design-framework.md |
| 美术 | style.md |
| 文案/叙事 | story.md → plot.md |
