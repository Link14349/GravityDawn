...
root = os.getcwd()
shields = [".idea", ".git", ".node_modules", "node_modules"]
lines = 0
sizes = 0
same = root
	...
	for i in files:
		...
		if e:
			if os.path.isdir(path):
				...
				if path.find(".js") > -1 or path.find(".html") > -1:
					file = open(path)
					content = file.read()
...
def help():
	print("\033[1m\033[37mGravityDawn Data Statistics Tool\033[0m")
	print("\033[1m\033[37mCopyright Link (c) 2026\033[0m")
...
def version():
	print("\033[1m\033[37mGravityDawn Data Statistics Tool \033[35mv-1.0.0\033[0m")
	print("\033[1m\033[37mCopyright Link (c) 2026\033[0m")
