...
const fs = require('fs');
const pages = ['index.html', 'test/phase9-demo.html', 'test/phase10-demo.html', 'test/phase11-demo.html', 'test/phase12-demo.html', 'test/phase13-demo.html', 'test/phase14-demo.html', 'test/phase15-demo.html', 'test/phase16-demo.html', 'test/phase17-demo.html'].filter(file => fs.existsSync(path.resolve(__dirname, file)));
