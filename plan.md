...
## Phase 20：分档时间滑动条 [x]
- [x] 将时间加速按钮替换为滑动条，支持 0.5×、1×、1.5×、2×、4×、5×、10×、20×，实时显示当前倍率
- [x] 小数倍率累积固定步进余量，暂停不推进，重试/新关恢复 1×
- [x] build + 浏览器验证（八档、实测小数倍率与 20×、暂停、重试/新关、桌面及窄屏拖动），同步相关技术文档
- [x] 产物：test/phase20-demo.html

## Phase 21：简报顶栏统一 Logo [x]
- [x] 简报顶栏替换旧 ⊕ 图标，复用「引力破晓」Logo 与共享尺寸样式
- [x] build + 浏览器验证（Logo、继续阅读和跳过简报），同步相关技术文档
- [x] 产物：test/phase21-demo.html

## Phase 22：追加十二关高难度战役 [x]
- [x] 追加深空攻坚、共振迷航、终局星阵三章，共 12 关；保留原 24 关与旧存档映射
- [x] 新增四种装甲蓝图，组合多据点、多引力源、移动目标与有限弹药
- [x] 使用生产模拟验证全部参考解、长期稳定性和新增关卡难度约束
- [x] build + 浏览器验证，同步关卡与技术文档
- [x] 产物：test/phase22-demo.html

## Phase 23：v1.0.0 正式发布 [x]
- [x] 整理正式版生产构建、独立运行包与版本校验信息
- [x] 更新正式版说明与部署流程，提供 test/phase23-demo.html
- [x] 全战役回归、build、正式包与阶段演示浏览器验证（36 关通过；Logo 保留已有体积提示）
- [x] 提交正式版并创建本地 v1.0.0 版本标签
